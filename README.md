...
* Food delivery promotional section
* Instamart section
* Dineout restaurant section
* Food category section
* Cities with food delivery section
* Swiggy app download banner
* Responsive footer
...
* **Bootstrap Icons** – Icons used throughout the webpage
...
5. Shop groceries on Instamart
6. Discover best restaurants on Dineout
7. Swiggy App Download Banner
...
* Working with Bootstrap responsive utilities
* Designing reusable UI sections
* Creating responsive cards
* Implementing horizontal scrolling sections
